...
const CHILD_FAILURE_CODES = new Map<string, string>([
  ...
  ['final build cache already exists', 'final-cache-exists'],
  ['proof overlay binding is not a symlink', 'overlay-binding-mismatch'],
  ['proof overlay binding target mismatch', 'overlay-binding-mismatch'],
  ['macOS SDK identity changed during the proof', 'sdk-identity-changed'],
  ['Git dependency source ref mismatch', 'git-source-ref-mismatch'],
  ['Git subprocess failed', 'git-subprocess-failed'],
  ['curl subprocess failed', 'curl-subprocess-failed'],
  ['file subprocess failed', 'file-subprocess-failed'],
  ['strip subprocess failed', 'strip-subprocess-failed'],
  ['tar subprocess failed', 'tar-subprocess-failed'],
  ['xcodebuild subprocess failed', 'xcodebuild-subprocess-failed'],
  ['xcrun subprocess failed', 'xcrun-subprocess-failed'],
  ['Zig version subprocess failed', 'zig-version-subprocess-failed'],
  ...
  ['dependency input generation does not match the proof recipe', 'recipe-generation-mismatch'],
  ['package tree generation plan does not match the proof recipe', 'recipe-generation-mismatch'],
  ['generation inputs do not match the proof recipe', 'recipe-generation-inputs-mismatch'],
  ['proof generated input plan does not match the proof recipe', 'recipe-generation-mismatch'],
  ['proof generated input materialization failed', 'generated-input-materialization-failed'],
  ['package cache changed during graph materialization', 'package-cache-materialization-mismatch'],
  ['generation changed the materialized package graph', 'package-graph-generation-mismatch'],
  ['generation changed the package cache', 'package-cache-generation-mismatch'],
  ...
  ['build argv does not match the proof recipe', 'recipe-build-argv-mismatch'],
  ['build environment does not match the proof recipe', 'recipe-build-environment-mismatch'],
  ['observed link argv does not match the proof recipe', 'recipe-link-argv-mismatch'],
  ['strip argv does not match the proof recipe', 'recipe-strip-argv-mismatch'],
  ['Zig build failed', 'native-build-failed'],
  ['generated input producer ran during final build', 'native-build-regenerated-input'],
  ['exact link driver command was not observed', 'native-link-observation-missing'],
